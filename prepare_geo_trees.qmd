...
- As **control**, we selected 30 trees randomly distributed across study area. To achieve this, we generated 30 random points within the study area polygon using `QGIS` (`Vector/Research Tools/Random points in polygon`). Each point was placed at least 5 m apart from the others. 
